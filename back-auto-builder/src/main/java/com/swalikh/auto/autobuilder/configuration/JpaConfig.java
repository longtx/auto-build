...
@Configuration
@EnableJpaRepositories(basePackages={"com.swalikh.auto.autobuilder.repository"}) //这个是你Repositorie所在的包
...
public class JpaConfig{
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.swalikh.auto.autobuilder.entity");//这个是你entity所在的包
